...
export const MUSEUMS: MuseumRegion[] = [
  {
    ...
    museums: [
      ...
      { name: 'RAF Museum London', city: 'Hendon', country: 'UK', flag: '\u{1F1EC}\u{1F1E7}', description: 'RAF history from Bleriot to F-35. Battle of Britain hall, Vulcan, and captured Luftwaffe jets.', match: ['raf museum'], url: 'https://www.rafmuseum.org.uk' },
